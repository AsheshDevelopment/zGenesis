...
Tasks page includes locally stored completion toggles and a client-side MD5
password gate. The plain-text password is not stored in the page, but this gate
is only a preview deterrent: static website source and restricted content remain
